...
import 'package:hesap.co_app/services/register_service.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> validate() async {
    if (formkey.currentState.validate()) {
      var responseStatus = await registerService.registerApiRequest(
      ...
      if (responseStatus == 200) {
        ...
        showDialog(
            context: context,
            builder: (context) =>
                AlertDialog(title: Text("Hesap oluştururlamadı.")));
        setState(() {
          loadingIcon = false;
        });
